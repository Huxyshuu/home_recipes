...
const paths = {
  ...
  leaf: <><path d="M20.5 3.5C13 3.7 7.3 6.2 4.6 10.8c-2.7 4.6-.5 8.9 3.9 9.7 5.4 1 9.7-3.2 12-17z"/><path d="M5.8 18.7c2.5-4.1 6.1-7.4 11.1-10"/><path d="M9.4 15.3c.2-2.1-.3-3.8-1.5-5.1M12.5 12.4c1.7.1 3.2.6 4.5 1.6"/></>,
